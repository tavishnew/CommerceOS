...
def insert_sample_products() -> bool:
    try:
        ...
        sample_data = [
            ...
            # ── Stage 10 / D — Realistic catalog spanning merchant caps ──
            # 4 small items (under $50), 4 mid items ($80-180), 4 large items ($200+).
            # Categories chosen to exercise the upsell matcher (Electronics, Office, Outdoor, Home).
            ('USB-C Hub 7-in-1', 'Compact hub with HDMI, 3xUSB, SD, Ethernet', 39.00, 120, 'HUB-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/hub', 'https://example.com/images/hub.jpg', 'USD', True, True, 'in_stock', 120,
             'HUB-GROUP', 'HUB-001', 'Electronics', 'Accessory', 0.03, 'Standard agent terms apply', 0.0, 0.08, 31.00,
             1, 30, '1 year manufacturer warranty', False, None, 'TechCorp', 'new', True, '3-5 business days',
             '[{"quantity": 10, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Mechanical Keyboard', 'Tactile brown switches, USB-C, hot-swap', 89.00, 60, 'KEY-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/keyboard', 'https://example.com/images/keyboard.jpg', 'USD', True, True, 'in_stock', 60,
             'KEY-GROUP', 'KEY-001', 'Electronics', 'Computer', 0.03, 'Standard agent terms apply', 0.0, 0.08, 71.00,
             1, 30, '1 year manufacturer warranty', False, None, 'TechCorp', 'new', True, '3-5 business days',
             '[{"quantity": 5, "discount": 0.07}]', 'Net 30 days', 0, False),

            ('Wireless Mouse', 'Ergonomic, USB-C charging, 4000 DPI', 45.00, 200, 'MOU-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/mouse', 'https://example.com/images/mouse.jpg', 'USD', True, True, 'in_stock', 200,
             'MOU-GROUP', 'MOU-001', 'Electronics', 'Computer', 0.03, 'Standard agent terms apply', 0.0, 0.08, 36.00,
             1, 30, '1 year manufacturer warranty', False, None, 'TechCorp', 'new', True, '3-5 business days',
             '[{"quantity": 10, "discount": 0.08}]', 'Net 30 days', 0, False),

            ('Desk Lamp', 'Warm task light, dimmable, USB charging', 65.00, 80, 'LMP-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/desk-lamp', 'https://example.com/images/desk-lamp.jpg', 'USD', True, True, 'in_stock', 80,
             'LMP-GROUP', 'LMP-001', 'Office', 'Lighting', 0.04, 'Standard agent terms apply', 0.0, 0.08, 52.00,
             1, 30, '1 year manufacturer warranty', False, None, 'OfficeCo', 'new', True, '3-5 business days',
             '[{"quantity": 5, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Standing Desk Mat', 'Anti-fatigue, 70x30cm, slate', 49.00, 90, 'MAT-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/desk-mat', 'https://example.com/images/desk-mat.jpg', 'USD', True, True, 'in_stock', 90,
             'MAT-GROUP', 'MAT-001', 'Office', 'Accessory', 0.04, 'Standard agent terms apply', 0.0, 0.08, 39.00,
             1, 30, '1 year manufacturer warranty', False, None, 'OfficeCo', 'new', True, '3-5 business days',
             '[{"quantity": 5, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Noise-Cancelling Earbuds', 'True wireless, 30h case, ANC', 129.00, 70, 'EAR-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/earbuds', 'https://example.com/images/earbuds.jpg', 'USD', True, True, 'in_stock', 70,
             'EAR-GROUP', 'EAR-001', 'Electronics', 'Audio', 0.03, 'Standard agent terms apply', 0.0, 0.08, 103.00,
             1, 30, '1 year manufacturer warranty', False, None, 'AudioCorp', 'new', True, '3-5 business days',
             '[{"quantity": 5, "discount": 0.07}]', 'Net 30 days', 0, False),

            ('Webcam 1080p', 'Auto-focus, USB-A, privacy shutter', 79.00, 110, 'CAM-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/webcam', 'https://example.com/images/webcam.jpg', 'USD', True, True, 'in_stock', 110,
             'CAM-GROUP', 'CAM-001', 'Electronics', 'Computer', 0.03, 'Standard agent terms apply', 0.0, 0.08, 63.00,
             1, 30, '1 year manufacturer warranty', False, None, 'TechCorp', 'new', True, '3-5 business days',
             '[{"quantity": 5, "discount": 0.06}]', 'Net 30 days', 0, False),

            ('Insulated Water Bottle', '750ml, double-wall, 24h cold', 35.00, 300, 'BTL-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/bottle', 'https://example.com/images/bottle.jpg', 'USD', True, True, 'in_stock', 300,
             'BTL-GROUP', 'BTL-001', 'Outdoor', 'Hydration', 0.04, 'Standard agent terms apply', 0.0, 0.08, 28.00,
             1, 30, '1 year manufacturer warranty', False, None, 'OutdoorCo', 'new', True, '3-5 business days',
             '[{"quantity": 10, "discount": 0.10}]', 'Net 30 days', 0, False),

            ('4K Monitor 27"', 'IPS, USB-C 65W, height-adjust', 349.00, 25, 'MON-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/monitor', 'https://example.com/images/monitor.jpg', 'USD', True, True, 'in_stock', 25,
             'MON-GROUP', 'MON-001', 'Electronics', 'Display', 0.03, 'Standard agent terms apply', 0.0, 0.08, 279.00,
             1, 30, '1 year manufacturer warranty', False, None, 'TechCorp', 'new', True, '3-5 business days',
             '[{"quantity": 3, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Ergonomic Office Chair', 'Mesh, lumbar support, 4D armrest', 229.00, 30, 'CHR-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/chair', 'https://example.com/images/chair.jpg', 'USD', True, True, 'in_stock', 30,
             'CHR-GROUP', 'CHR-001', 'Office', 'Furniture', 0.05, 'Standard agent terms apply', 0.0, 0.08, 183.00,
             1, 30, '1 year manufacturer warranty', False, None, 'OfficeCo', 'new', True, '7-10 business days',
             '[{"quantity": 2, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Carbon Fiber Tripod', '15kg load, 1.5m, ball head', 219.00, 18, 'TRI-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/tripod', 'https://example.com/images/tripod.jpg', 'USD', True, True, 'in_stock', 18,
             'TRI-GROUP', 'TRI-001', 'Outdoor', 'Photography', 0.04, 'Standard agent terms apply', 0.0, 0.08, 175.00,
             1, 30, '1 year manufacturer warranty', False, None, 'OutdoorCo', 'new', True, '5-7 business days',
             '[{"quantity": 3, "discount": 0.06}]', 'Net 30 days', 0, False),

            ('Smart Coffee Grinder', '40-step grind, USB-C, scale', 159.00, 40, 'GRD-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/grinder', 'https://example.com/images/grinder.jpg', 'USD', True, True, 'in_stock', 40,
             'GRD-GROUP', 'GRD-001', 'Home', 'Kitchen', 0.04, 'Standard agent terms apply', 0.0, 0.08, 127.00,
             1, 30, '1 year manufacturer warranty', False, None, 'HomeCo', 'new', True, '3-5 business days',
             '[{"quantity": 3, "discount": 0.05}]', 'Net 30 days', 0, False),

            ('Robot Vacuum', 'LIDAR, 3000Pa, mop, app control', 289.00, 22, 'VAC-001', 'Active', 'tracked', 1,
             '2024-11-01T10:00:00Z', 'https://example.com/vacuum', 'https://example.com/images/vacuum.jpg', 'USD', True, True, 'in_stock', 22,
             'VAC-GROUP', 'VAC-001', 'Home', 'Appliance', 0.04, 'Standard agent terms apply', 0.0, 0.08, 231.00,
             1, 30, '1 year manufacturer warranty', False, None, 'HomeCo', 'new', True, '5-7 business days',
             '[{"quantity": 2, "discount": 0.05}]', 'Net 30 days', 0, False),
        ]
