 ...
 */
import type { JSONRPCError, JSONRPCErrorResponse } from './errors.js';
import type { Message, Task, Artifact, PushNotificationConfig, TaskStatus } from './protocol_objects.js';
/**
