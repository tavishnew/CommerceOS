...
import { A2AClientHTTPError, A2AClientJSONError } from "./errors.js";
/**
 * Agent Card resolver
 */
export class A2ACardResolver {
     ...
     */
    constructor(baseUrl, agentCardPath = "/.well-known/agent.json", fetchImpl) {
    ...
    async getAgentCard() {
        try {
            const response = await this.fetchImpl(`${this.baseUrl}/${this.agentCardPath}`);
            if (!response.ok) {
...
export class A2AClient {
     ...
     * @returns Task | null
     */
    async sendTask(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
            method: "tasks/send",
     ...
     */
    async *sendTaskSubscribe(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
     ...
     * @returns Async generator yielding SendTaskStreamingResponse events
     */
    async *resubscribeTask(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
     ...
     * @returns Task | null
     */
    async getTask(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
            method: "tasks/get",
     ...
     */
    async cancelTask(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
            method: "tasks/cancel",
     ...
     */
    async setTaskPushNotificationConfig(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
     ...
     */
    async getTaskPushNotificationConfig(params, requestId = uuidv4()) {
        const request = {
            jsonrpc: "2.0",
            id: requestId,
